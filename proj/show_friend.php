...
else
{
	...
	{
		if($f['send_by']==$user_name) echo "<a href=profile.php?q=".$f['received_by']."><strong>".$f['received_by']."</strong></a>&nbsp; &nbsp;   <br/>";
		else if($f['received_by']==$user_name) echo "<a href=profile.php?q=".$f['send_by']."><strong>".$f['send_by']."</strong></a>&nbsp &nbsp;  <br/>";
	}
